...
const ChefDashboard = () => {
  ...
  const quickActions = [
    ...
    {
      title: "New Requests",
      description: `${stats.pendingOrders} awaiting review`,
      icon: FaClock,
      link: "/dashboard/request-order",
    ...
    <div className="p-4">
      ...
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-1">
          Chef's Dashboard <FaCrown className="inline text-amber-500 ml-1" />
        </h1>
        <p className="text-gray-600">
          Your culinary creations are making people happy! Keep cooking with passion.
        </p>
        <div className="mt-2 inline-block bg-amber-100 text-amber-800 px-3 py-1 rounded text-sm font-medium">
          Chef ID: {chefId}
        </div>
      </div>
      ...
      {/* Quick Actions */}
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-3">Quick Tools</h2>
          ...
          {quickActions.map((action, index) => (
            ...
            >
              <div className="flex items-start justify-between mb-2">
                ...
                {action.badge > 0 && (
                  <span className="bg-rose-500 text-white text-xs font-bold px-2 py-0.5 rounded animate-pulse">
                    {action.badge}
                  </span>
                )}
              </div>
      ...
      <div className="bg-white rounded-lg shadow p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-amber-50 rounded-lg border border-amber-100">
            <FaUtensils className="text-3xl text-amber-500 mx-auto mb-2" />
        ...
        {stats.pendingOrders > 0 && (
          <div className="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-3">
            <div className="flex items-center gap-2">
              ...
              <Link
                to="/dashboard/request-order"
                className="ml-auto btn-sm bg-amber-500 hover:bg-amber-600 text-white"
              >
                Review Now
              </Link>
            </div>
